...
const ELECTRIC_FORKLIFT_SERIES: ProductSeries[] = [
  ...
  },
  {
    ...
    detail: {
      ...
      specsPdfUrl: "/documents/fe4p40-50q-l-en.pdf",
      specsPdfFilename: "FE4P40-50Q(L).pdf",
      specsPdfUrlEn: "/documents/fe4p40-50q-l-en.pdf",
      specsPdfFilenameEn: "FE4P40-50Q(L).pdf",
